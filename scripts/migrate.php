...
$grammarSeed = [
    'A1' => [
        ...
        'Countable and Uncountable Basics',
        ...
        'Like and Want Structures',
        'Have got and Has got',
        'Basic Genitive and Possession',
    ],
    'A2' => [
        ...
        'Could for Requests and Ability',
        'May for Permission',
        'Basic Relative Clauses who which that',
        'Time Clauses when before after',
        'First Contrast Linkers although however',
        'Reflexive Pronouns',
    ],
    'B1' => [
        'Present Perfect',
        ...
        'Basic Passive Voice',
        'Have something done Intro',
        'Indirect Questions',
        'Discourse Markers for Opinions',
    ],
    'B2' => [
        'Past Perfect',
        ...
        'Concession Contrast Structures',
        'Inversion for Emphasis',
        'Hedging Expressions',
        'Nominal Relative Clauses what whatever',
    ],
    'C1' => [
        ...
        'Parallel Structures',
        'Advanced Reference Cohesion',
        'Inversion in Formal Speech',
        'Determinative Precision',
        'Discourse Framing for Presentations',
        'Pragmatic Softening',
        'Graduation and Intensification',
    ...
    'C2' => [
        ...
        'Prosodic Syntax Matching',
        'Hypothetical Layering',
        'Meta Argument Constructions',
        'Contrastive Stance Sequences',
        'Precision through Reformulation',
        'Syntactic Rhythm Control',
        'Pragmatic Ambiguity Control',
    ],
];

$grammarStmt = $pdo->prepare(
    'INSERT INTO grammar_topics (level_id, slug, title, position)
     VALUES (
       (SELECT id FROM levels WHERE code = :level_code LIMIT 1),
       :slug,
       :title,
...
$clearGrammarByLevelStmt = $pdo->prepare(
    'DELETE g FROM grammar_topics g
     INNER JOIN levels l ON l.id = g.level_id
     WHERE l.code = :level_code'
);

foreach ($grammarSeed as $levelCode => $titles) {
    $clearGrammarByLevelStmt->execute(['level_code' => $levelCode]);
    $position = 1;
    foreach ($titles as $title) {
        $slug = strtolower(trim(preg_replace('/[^a-z0-9]+/i', '-', $title), '-'));
        $grammarStmt->execute([
